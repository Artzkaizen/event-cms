...
export interface ApiAccessibilityFeatureAccessibilityFeature
  ...
  attributes: {
    ...
    type: Schema.Attribute.Enumeration<
      ['mobility', 'visual', 'hearing', 'cognitive', 'sensory', 'communication']
    >;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiDisabilityCardDisabilityCard
  ...
  attributes: {
    ...
    issuingCard: Schema.Attribute.String;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
...
export interface ApiEventEvent extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    eventType: Schema.Attribute.Enumeration<
      ['movie', 'concert', 'exhibition', 'theater', 'workshop', 'conference']
    > &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
...
export interface ApiLocationLocation extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    contactDetails: Schema.Attribute.String &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiOrganizerOrganizer extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    publishedAt: Schema.Attribute.DateTime;
    type: Schema.Attribute.Enumeration<
      ['individual', 'company', 'organization', 'government']
    >;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiTicketTicket extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    disabilityCard: Schema.Attribute.Relation<
      'oneToOne',
      'api::disability-card.disability-card'
    >;
    event: Schema.Attribute.Relation<'manyToOne', 'api::event.event'>;
    format: Schema.Attribute.Enumeration<['physical', 'digital', 'mobile']>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::ticket.ticket'
    ...
    ticketType: Schema.Attribute.Enumeration<
      ['regular', 'student', 'senior', 'accessibility', 'companion']
    >;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface PluginUsersPermissionsUser
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    disabilityCards: Schema.Attribute.Relation<
      'oneToMany',
      'api::disability-card.disability-card'
    >;
    email: Schema.Attribute.Email &
